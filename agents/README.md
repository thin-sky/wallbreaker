...
1.  **Tech Stack**: Astro 6.x, Hono, Cloudflare (Workers, D1, R2, Workflows), Zod, Custom Elements.
...
7.  **Documentation**: **NEVER** generate implementation summaries, "readmes", or technical docs unless explicitly requested. Keep all technical truth in this `/agents/` folder.
...
- **Minimal Documentation**: Do not create new documentation files, summaries, or `IMPLEMENTATION_SUMMARY.md` files. Update existing files in `/agents/` if architectural changes occur.
